...
{
    /// <inheritdoc />
    public partial class manyToManyFluentAPI : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategory", x => new { x.ProductProductId, x.CategoryCategoryId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategory_Products_ProductProductId",
